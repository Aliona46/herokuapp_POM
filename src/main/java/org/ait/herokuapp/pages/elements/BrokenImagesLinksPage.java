package org.ait.herokuapp.pages.elements;
...
public class BrokenImagesLinksPage extends BasePage {

    public BrokenImagesLinksPage(WebDriver driver) {
        super(driver);
    }

    @FindBy(tagName = "img")
    List<WebElement> images;
    public BrokenImagesLinksPage checkBrokenImages() {
